...
namespace DYong.Business.SystemSecurity 
{
    public class LogApp 
    {
        ...
        public List<LogEntity> GetList(string queryJson)
        {
            ...
            ResultClass<IQueryable<LogEntity>> _ret = service.IQueryable(expression);
            if (_ret.Result)
            {
        ...
        public List<LogEntity> GetList(Pagination pagination, string queryJson)
        {
            ...
            //return service.FindList(expression, pagination).ResultData;
            ResultClass<List<LogEntity>> _ret = service.FindList(expression, pagination);
        ...
        public void RemoveLog(string keepTime)
        {
            ...
            ResultClass<int>_ret= service.Delete(expression);
